...
export default {
  data() {
    return {
      heroContent: {
        heroImage: `/assets/images/hero/profile.jpg`,
        heroMobileImage: `/assets/images/hero/profile.jpg`,
        heroTitleName: "Jomar Manalo",
        heroDesignation: "web developer",
        heroDescriptions: `I'm a Filipino based web developer focused on
